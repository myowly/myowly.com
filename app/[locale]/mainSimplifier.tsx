...
export default function MainSimplifier() {
  return (
    <Box py="100px" id="benefits">
      ...
      >
        <ButtonLink href="#roadmap" minWidth={[null, null, null, "400px", "500px"]}>Déroulement du projet</ButtonLink>
        <ButtonLink href="#joinUs" minWidth={[null, null, null, "400px", "500px"]}>Rejoindre la Newsletter</ButtonLink>
      </Flex>
    </Box >
  )
}
